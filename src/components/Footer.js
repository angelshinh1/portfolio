                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                    ...
                    <div className="flex gap-3 justify-center">
                        <a
                            ...
                            aria-label="GitHub"
                            className="p-2.5 rounded-lg border border-[rgba(255,255,255,0.10)] bg-[rgba(255,255,255,0.05)] text-[rgba(236,236,236,0.6)] transition-[transform,color] duration-200 ease-[var(--ease-out)] hover:text-[var(--green-muted)] hover:-translate-y-0.5 active:scale-95"
                        >
