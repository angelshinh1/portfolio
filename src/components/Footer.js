            ...
            <div className="max-w-[88vw] lg:max-w-[64rem] mx-auto pt-14 lg:pt-16 pb-14 lg:pb-16">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                    ...
                    <div className="text-center lg:text-left">
                        <h3 className="type-heading text-[#ECECEC]">
                            Angel Shinh
                        </h3>
                    ...
                    <div className="flex gap-3 justify-center">
                        <a
                            ...
                            aria-label="GitHub"
                            className="press-strong p-3 rounded-full border border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.06)] text-[rgba(236,236,236,0.65)] backdrop-blur-sm transition-[translate,color,background] duration-300 ease-[var(--spring)] hover:text-[var(--green-muted)] hover:bg-[rgba(255,255,255,0.1)] hover:-translate-y-0.5"
                        >
                ...
                <div className="mt-12 pt-6 border-t border-[rgba(255,255,255,0.08)]">
                    <p className="font-mono text-center text-xs text-[rgba(236,236,236,0.35)] tracking-tight">
