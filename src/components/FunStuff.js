    ...
    return (
        ...
        >
            ...
            <Reveal className="mb-20 lg:mb-24">
                <div className="grid grid-cols-1 lg:grid-cols-[0.7fr_1fr] gap-10 lg:gap-14 items-center">
                    ...
                    <div>
                        ...
                        <p className="font-body text-base lg:text-lg leading-relaxed text-[var(--text-secondary)] mt-5 max-w-[46ch]">
                            Been playing guitar for 2 years and it&apos;s my{" "}
                            <mark>go-to way to unwind</mark>. The song in this video is{" "}
                            <a
                                className="text-[var(--green-deep)] underline decoration-[var(--green-muted)] underline-offset-4 hover:decoration-[var(--green-vivid)] transition-colors"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {hobbies.map((hobby, index) => (
                            <Reveal
                                ...
                                className="group flex items-center gap-3 border border-[var(--line)] bg-[var(--bg-surface)] px-4 py-3.5 transition-[transform,box-shadow] duration-300 ease-[var(--ease-out)] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)]"
            ...
            <div>
                <Reveal>
                    <h3 className="font-heading text-2xl lg:text-3xl text-[var(--text-primary)] mb-8">
                        <span className="initial">L</span>ife in snapshots 📸
                    </h3>
                </Reveal>
